% ===============================
% Partial order planning program.
% ===============================
...
plan_with_pop(StartState, Goals, Plan) :-
...
s(pop(Acts, [Cond:Time | OpenPsO], TrueCondsO, Fin), pop([Action1:Time1 | Acts], OpenPs, TrueConds, Fin)) :-
